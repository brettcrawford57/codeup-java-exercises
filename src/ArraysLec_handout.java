...
public class ArraysLec_handout {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("groceryList = " + groceryList[5]);
...
//        System.out.println("sidesArray[6] = " + sidesArray[6]);
        ...
        System.out.println("Hey, good to see you today " + cohorts[0] + " students! Did you know the next cohort is going to be named " + cohorts[3] + "?");
        ...
        String[] foods = {"Spaghetti", "Pizza", "Chicken", "Pineapples"};

        System.out.println("Hey, man! Do you want some " + foods[1] + "?");
...
//
//        System.out.println(cohortNameString);
